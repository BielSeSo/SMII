...
faceinit ( void )
{
  face = create_face         ("code/geoface/geoface_data/index.dat", "code/geoface/geoface_data/faceline.dat") ;
  read_muscles               ("code/geoface/geoface_data/muscle.dat", face ) ;
  read_expression_vectors    ("code/geoface/geoface_data/expression-vectors.dat", face ) ;
  data_struct                ( face ) ;	
}
